...
int main() {
    ...
    std::string inputFilePath = "/home/roko/cursos/mineria-mkp-main/mkp/datos/solucionadosPequenos/menosDe20Items/pet3.dat";
    std::string outputFilePath = "pet3-todo.csv";
